...
But there is something weird with the `session number`, it tells us it is `undefined`. This will be more important later for the [DOM clobbering exploit](#exploitation-variant-1-dom-clobbering). Creating a new post with some `<b>` HTML tag will reveal that we effectively got HTML injection:
...
## Exploitation Variant 1 - DOM Clobbering
...
## Exploitation Variant 2 - Submit Form
...
## Exploitation Variant 3 - iframe YouTube Open Redirect
...
## Exploitation Variant 5 - I…LOVE CHEESE!🧀
